                            ...
                            <div class="card-body mx-4 mt-4">
                                <div class="table-responsive">
                                    ...
                                    <?php if(sizeof($myproducts) > 0) { ?>
                                        ...
                                        <!-- Table body -->
                                        <tbody>
                                                <?php $user_id = AuthComponent::password($this->Session->read('Auth')['User']['id']); ?>
                                                <?php foreach($myproducts as $myproduct): ?>
                                                    <!-- First row -->
                                                    <tr>
                                                        <th scope="row">
                                                            <?php echo $this->Html->image('upload_folder/'.$user_id.'/'.$myproduct['ProductPicture']['picture']); ?>
                                                        </th>
                                                        <td>
                                                        ...
                                                        <td><?php echo $myproduct['ProductInformation']['product_quantity']; ?></td>
                                                        <td>
                                                            <button type="button" class="btn btn-sm btn-primary waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="" data-original-title="Remove item">Out of Stock
                                                            </button>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
